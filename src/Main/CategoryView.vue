...
export default {
  components: { HeaderAfterLogin, AuthFooter, Swiper, SwiperSlide, CategoryItem2, ProducCard2 },
  data() {
    return {
      categories: [
        { name: 'AKRILIK', image: 'https://placehold.co/100', link: '/category-view' },
        { name: 'STIKER', image: 'https://placehold.co/100', link: '/category-view' },
        { name: 'T-SHIRT', image: 'https://placehold.co/100', link: '/category-view' },
        { name: 'KANVAS', image: 'https://placehold.co/100', link: '/category-view' },
        { name: 'DISPLAY', image: 'https://placehold.co/100', link: '/category-view' },
        { name: 'AKRILIK', image: 'https://placehold.co/100', link: '/category-view' },
        { name: 'STIKER', image: 'https://placehold.co/100', link: '/category-view' },
        { name: 'T-SHIRT', image: 'https://placehold.co/100', link: '/category-view' },
        { name: 'KANVAS', image: 'https://placehold.co/100', link: '/category-view' },
